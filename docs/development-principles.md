...
- workflow skills orchestrate role entry skills only
...
Prefer adding a small composable foundational contract or role skill over making one workflow absorb unrelated responsibilities.
